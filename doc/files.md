...
gope.conf        | contains configuration settings for goped or gope-qt
goped.pid        | stores the process id of goped while running
...
debug.log           | contains debug information and general logging generated by goped or gope-qt
