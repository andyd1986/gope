# Support for Output Descriptors in Gope Core

Since Gope Core v0.17, there is support for Output Descriptors. This is a
...
on Gope's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Gope Core wallets, a convenience function `combo` is
