...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gope-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gope-tx [options] <hex-tx> [commands]  Update hex-encoded gope transaction\n" +
            "or:     gope-tx [options] -create [commands]   Create hex-encoded gope transaction\n" +
            "\n";
