...
"""Verify that starting gope with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gope with -h for help text")
        ...
        self.log.info("Start gope with -version for version information")
        ...
        self.log.info("Start goped with -fakearg to make sure it does not start")
